...
var camera   = new THREE.PerspectiveCamera(60, window.innerWidth / window.innerHeight, 1, 1500),
    ...
    mat      = new THREE.ParticleBasicMaterial({ color: 0x3191FF, size: 6 }),
    radius   = 700;
...
cities.forEach(function(city) {
  var vertex = geoToCartesian(city[0], city[1], 500);
  
  geometry.vertices.push(vertex);

  var factor = 100 + Math.random() * 5000;
  var growth = Math.min(1.9, 0.35 + Math.random());
